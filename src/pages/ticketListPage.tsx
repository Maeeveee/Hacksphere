...
export default function TicketListPage({ searchParams }: TicketListPageProps) {
    ...
    const tickets = generateSampleTickets(searchParams);
    const totalPassengers = searchParams.adults + searchParams.children;

    // Check if we have valid search params
    const hasValidSearch = searchParams.origin && searchParams.destination && searchParams.departureDate;
    ...
    const getClassRating = (trainClass: string) => {
        switch (trainClass.toLowerCase()) {
            case 'eksekutif':
                return 5;
            case 'bisnis':
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="font-bold text-gray-800 flex items-center gap-2">
                                            <span className="text-sm">{searchParams.origin || 'Stasiun Asal'}</span>
                                            <ChevronRight className="w-3 h-3 text-gray-400" />
                                            <span className="text-sm">{searchParams.destination || 'Stasiun Tujuan'}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white/80 p-4 rounded-xl shadow-sm border border-purple-100">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="font-bold text-gray-800 text-sm">
                                            {searchParams.adults} Dewasa{searchParams.children > 0 ? `, ${searchParams.children} Anak` : ''}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-1 flex-wrap">
                                            ...
                                            {!searchParams.isDifabel && !searchParams.isPulangPergi && (
